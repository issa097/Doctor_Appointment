...
namespace DoctorAppointment.Controllers
{
   // [Authorize]
    public class AppointmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,CreatedDate,DoctorId,PatientId")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,CreatedDate,DoctorId,PatientId")] Appointment appointment)
        {
